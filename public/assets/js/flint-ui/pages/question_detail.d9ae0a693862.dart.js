...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    mergeComponentProps(props, className, dartStyle, defaultStyle, style) {
      ...
      if (t1)
        ...
        t5 = dartStyle.sm != null || dartStyle.md != null || dartStyle.lg != null || dartStyle.xl != null || dartStyle.hover != null || dartStyle.focusVisible != null || dartStyle.active != null || dartStyle.disabled != null || dartStyle.invalid != null || dartStyle.light != null || dartStyle.dark != null;
      if (t5 === true) {
        dartStyle.toString;
    ...
    TextField$(controller, inputDartStyle, label, $name, placeholder, type) {
      var _null = null,
        ...
        t2 = controller._text;
      return new A.TextField("div", t1, A.TextField__children(false, A.resolveFieldError(_null, _null, $name), _null, inputDartStyle, B.Map_empty1, B.Map_empty1, label, $name, A.TextField__controlledOnChanged(controller, _null), _null, placeholder, false, false, B.ComponentSize_2, type, t2, B.InputVariant_0));
    },
    ...
    TextField__children(disabled, error, helpText, inputDartStyle, inputProps, inputStyle, label, $name, onChanged, onSubmitted, placeholder, readonly, required, size, type, value, variant) {
      var ariaDescribedBy, t1, t2, t3,
      ...
      t1 = A._setArrayType([], type$.JSArray_FlintNode);
      t1.push(A.fieldLabel(id, label, false));
      t2 = A.LinkedHashMap_LinkedHashMap$of(A.controlProps(ariaDescribedBy, false, error, id, $name, inputProps, false), type$.String, type$.nullable_Object);
      ...
      t3 = A.inputComponentStyle(false, error != null && error.length !== 0, size, variant);
      t1.push(new A.FlintElement("input", A.mergeComponentProps(t2, null, t3.merge$1(null).merge$1(inputDartStyle), B.Map_empty1, inputStyle), B.List_empty2));
      B.JSArray_methods.addAll$1(t1, A.fieldMessages(error, helpText, id));
      return t1;
    },
    ...
    inputComponentStyle(disabled, invalid, size, variant) {
      var _null = null, _s5_ = "solid",
        ...
        t6 = A.DartStyle$(_null, _null, _null, _null, _null, _null, _null, new A.Border(1, new A.TokenRef("color.primarySolid", "#155eef").toCss$0(), _s5_), _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, new A.Shadow(0, 0, 3, new A.TokenRef("color.primaryFocus", "#155eef").toCss$0()), _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null),
        t7 = A.DartStyle$(_null, _null, _null, _null, _null, _null, _null, new A.Border(1, new A.TokenRef(_s17_, _s7_).toCss$0(), _s5_), _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, new A.Shadow(0, 0, 3, new A.TokenRef("color.dangerFocus", _s7_).toCss$0()), _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null),
        base = A.DartStyle$(_null, _null, _null, _null, _null, t4, _null, new A.Border(1, t1, _s5_), _null, _null, _null, _null, _null, _null, _null, _null, t3, _null, _null, A.DartStyle$(_null, _null, _null, _null, _null, new A.TokenRef("color.disabledSurface", "#f3f4f6").toCss$0(), _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, new A.TokenRef("color.disabledText", "#98a2b3").toCss$0(), B.Cursor_Yvp, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null), _null, _null, _null, _null, _null, _null, _null, _null, _null, t6, B.FontFamily_Cjp, _null, _null, _null, _null, _null, _null, _null, t7, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, t2, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, t5, _null, _null, B.SizeValue_lLc, _null, _null, _null, _null).merge$1(A.inputSizeStyle(size));
      switch (variant.index) {
        case 0:
          t1 = B.DartStyle_0x90;
          break;
        case 1:
          t1 = A.DartStyle$(_null, _null, _null, _null, _null, new A.TokenRef("color.inputSoft", "#f9fafb").toCss$0(), _null, new A.Border(1, B.Color_transparent, _s5_), _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null);
          break;
        case 2:
          t1 = A.DartStyle$(_null, _null, _null, _null, _null, B.Color_transparent, _null, B.Border_1_Color_transparent_solid, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null);
          break;
        default:
          t1 = _null;
      }
      t1 = base.merge$1(t1);
      t1 = t1.merge$1(_null);
      return t1.merge$1(invalid ? A.DartStyle$(_null, _null, _null, _null, _null, _null, _null, new A.Border(1, new A.TokenRef(_s17_, _s7_).toCss$0(), _s5_), _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null) : _null);
    },
    inputSizeStyle(size) {
      var t1;
      switch (size.index) {
  ...
  A.ToastService.prototype = {
    ...
    _show$7$accent$background$border$duration$message$placement(title, accent, background, border, duration, message, placement) {
      ...
      t2.minWidth = "280px";
      t2.maxWidth = "380px";
      t2.padding = "12px 16px";
      t2.borderRadius = "12px";
      t2.border = "1px solid " + border;
      t2.background = background;
      t2.color = "#f8fafc";
      t2.boxShadow = "0 20px 50px rgba(0, 0, 0, 0.32)";
      t2.pointerEvents = "auto";
      t2.transform = "translateY(-8px) scale(0.96)";
      t2.opacity = "0";
      t2.transition = "opacity 180ms cubic-bezier(0.16, 1, 0.3, 1), transform 180ms cubic-bezier(0.16, 1, 0.3, 1)";
  ...
  A.ToastService__show_closure.prototype = {
    call$0() {
      ...
      t1.opacity = "1";
      t1.transform = "translateY(0) scale(1)";
    },
    $signature: 0
  };
  A.ToastService__show_closure0.prototype = {
    call$0() {
      ...
      t2.opacity = "0";
      t2.transform = "translateY(-8px) scale(0.96)";
      A.Timer_Timer(B.Duration_200000, new A.ToastService__show__closure(t1, this.container));
    },
    $signature: 0
  };
  ...
  A.DartStyle.prototype = {
    ...
    merge$1(override) {
      var t1, t2, t3, t4, t5, t6, t7, t8, t9, t10, t11, t12, t13, t14, t15, t16, t17, t18, t19, t20, t21, t22, t23, t24, t25, t26, t27, t28, t29, t30, t31, t32, t33, t34, t35, t36, t37, t38, t39, t40, t41, t42, t43, t44, t45, t46, t47, t48, t49, t50, t51, t52, t53, t54, _this = this;
      if (override == null)
        return _this;
      t1 = override.padding;
      if (t1 == null)
      ...
      if (t54 == null)
        t54 = _this.xl;
      return A.DartStyle$(t46, t11, _this.animation, _this.aspectRatio, t26, t36, _this.backgroundClip, t38, t40, _this.borderCollapse, _this.borderLeft, _this.borderRight, t39, t18, t22, _this.checked, t32, t34, t50, t47, t9, _this.expanded, _this.flex, _this.flexBasis, t13, _this.flexGrow, _this.flexShrink, t14, _this.focus, t45, t27, t28, t29, t10, _this.gradient, _this.gridTemplateColumns, t4, t44, t48, t12, _this.justifyItems, t19, t31, t53, t49, t30, t2, _this.maskImage, t8, t6, t52, t7, t5, t24, t42, t21, _this.overflowWrap, _this.overflowX, _this.overflowY, t1, t15, t37, t35, t17, t23, _this.scrollbarDisplay, _this.selected, t41, t51, _this.textAlign, t33, _this.textOverflow, _this.textTransform, t16, t25, t43, _this.webkitBackgroundClip, _this.whiteSpace, t3, _this.willChange, _this.wordBreak, t54, t20);
    }
  };
  ...
  A.QuestionDetailPage.prototype = {
    ...
    build$0() {
      var t6, t7, _this = this, _null = null,
        ...
        _s11_ = "color.muted",
        t1 = _this.props,
        t2 = A.DartStyle$(_null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, B.Display_grid_5_grid, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, 22, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, new A.EdgeInsets(_null, B.SizeValue_auto, _null, B.SizeValue_auto), _null, _null, 960, A.DartStyle$(_null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, new A.EdgeInsets(48, 16, 48, 16), _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null), _null, _null, _null, _null, B.Overflow_hidden, _null, _null, _null, new A.EdgeInsets(34, 16, 34, 16), _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, new A.SizeValue("100%"), _null, _null, _null, _null),
        t3 = A.DartStyle$(_null, _null, _null, _null, _null, new A.TokenRef("color.panel", _null), _null, new A.Border(1, new A.TokenRef("color.line", _null), "solid"), _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, B.Display_grid_5_grid, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, 14, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, A.DartStyle$(_null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, new A.EdgeInsets(28, 28, 28, 28), _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null), _null, 0, _null, _null, _null, _null, _null, _null, new A.EdgeInsets(20, 20, 20, 20), _null, 22, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null),
        t4 = A.DartStyle$(_null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, B.Display_flex_3_flex, _null, _null, _null, _null, _null, _null, B.C_FlexWrap, _null, _null, _null, _null, _null, 10, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null),
        t5 = _this.get$_question().$index(0, "tag");
      t5 = t5 == null ? _null : J.toString$0$(t5);
      if (t5 == null)
        t5 = _s8_;
      t6 = A.mergeComponentProps(B.Map_empty1, _null, A.DartStyle$(_null, _null, _null, _null, _null, new A.Color("rgba(2, 132, 199, 0.08)"), _null, new A.Border(1, new A.Color("rgba(2, 132, 199, 0.28)"), "solid"), _null, _null, _null, _null, _null, _null, _null, _null, new A.TokenRef("color.accent", _null), _null, B.DartStyle_54s, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, new A.EdgeInsets(5, 10, 5, 10), _null, 999, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null), B.Map_empty1, B.Map_empty1);
      t5 = A.normalizeChildren(t5, B.List_empty1);
      t7 = _this.get$_question().$index(0, "date");
      t7 = t7 == null ? _null : J.toString$0$(t7);
      if (t7 == null)
        t7 = "";
      t4 = A.Row$([new A.Container("div", t6, t5), A.Text_span(t7, A.DartStyle$(_null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, new A.TokenRef(_s11_, _null), _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, 12, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null))], t4);
      t7 = _this.get$_question().$index(0, "title");
      t5 = t7 == null ? _null : J.toString$0$(t7);
      if (t5 == null)
        t5 = _s8_;
      t5 = A._element("h1", t5, _null, B.Map_empty1, B.Map_empty1, A.DartStyle$(_null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, new A.TokenRef("color.text", _null), _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, 29, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, 1.2, new A.EdgeInsets(0, 0, 0, 0), _null, _null, _null, A.DartStyle$(_null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, 34, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null), _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null));
      t6 = _this.get$_question().$index(0, "body");
      t6 = t6 == null ? _null : J.toString$0$(t6);
      if (t6 == null)
        t6 = "";
      t6 = A.Text_p(t6, A.DartStyle$(_null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, new A.TokenRef(_s11_, _null), _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, 15, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, 1.75, new A.EdgeInsets(0, 0, 0, 0), _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null));
      t7 = _this.get$_question().$index(0, "author");
      t7 = t7 == null ? _null : J.toString$0$(t7);
      if (t7 == null)
        t7 = "Community";
      t7 = A.Text_span("By " + t7, A.DartStyle$(_null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, new A.TokenRef(_s11_, _null), _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, 12, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null));
      ...
      if (!(J.$eq$(t1.$index(0, "isAuthenticated"), true) || B.C_AuthSessionManager.get$token() != null)) {
        ...
        t7.push(A.Text_p("Your account can read answers but cannot post yet.", A.DartStyle$(_null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, new A.TokenRef("color.warning", _null), _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null)));
    ...
    _answersList$1(answers) {
      ...
      t1 = A.DartStyle$(_null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, B.Display_grid_5_grid, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, 14, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null);
      t2 = A.DartStyle$(_null, B.AlignItems_1_center, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, B.Display_flex_3_flex, _null, _null, _null, _null, _null, _null, B.C_FlexWrap, _null, _null, _null, _null, _null, 12, _null, _null, _null, _null, _null, B.JustifyContent_P8D, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null);
      t3 = A.Text_h2("Answers", A.DartStyle$(_null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, new A.TokenRef("color.text", _null), _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, 22, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, new A.EdgeInsets(0, 0, 0, 0), _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null));
      connected = this._liveStatus === "Live";
      t4 = connected ? B.Color_wdu : B.Color_HYX;
      t5 = connected ? B.Color_OOk : B.Color_HYX0;
      t4 = A.DartStyle$(_null, B.AlignItems_1_center, _null, _null, _null, t5, _null, new A.Border(1, t4, "solid"), _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, B.Display_eAD, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, 7, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, B.EdgeInsets_6_10_6_10, _null, 999, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null);
      t5 = A.mergeComponentProps(B.Map_empty1, _null, A.DartStyle$(_null, _null, _null, _null, _null, connected ? B.Color_UWZ : B.Color_ZUt, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, 7, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, 999, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, 7, _null, _null, _null, _null), B.Map_empty1, B.Map_empty1);
      t6 = A.normalizeChildren(_null, B.List_empty1);
      t7 = this._liveStatus;
      t7 = A.Text_span(t7, A.DartStyle$(_null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, connected ? new A.TokenRef("color.primary", _null) : new A.TokenRef("color.warning", _null), _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, 12, 800, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null));
      ...
      if (t3.get$isEmpty(answers))
        t2.push(A.Text_p("No answers yet. Be the first to help.", A.DartStyle$(_null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, new A.TokenRef("color.muted", _null), _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null)));
      else
    ...
    _answerCard$1(answer) {
      ...
      t1 = A.DartStyle$(_null, _null, _null, _null, _null, new A.TokenRef("color.panel", _null), _null, new A.Border(1, new A.TokenRef("color.line", _null), "solid"), _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, B.Display_grid_5_grid, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, 10, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, A.DartStyle$(_null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, new A.EdgeInsets(18, 18, 18, 18), _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null), _null, 0, _null, _null, _null, _null, _null, _null, new A.EdgeInsets(16, 16, 16, 16), _null, 14, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null);
      t2 = answer.$index(0, "body");
      t2 = t2 == null ? _null : J.toString$0$(t2);
      if (t2 == null)
        t2 = "";
      t2 = A.Text_p(t2, A.DartStyle$(_null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, new A.TokenRef(_s11_, _null), _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, 14, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, 1.7, new A.EdgeInsets(0, 0, 0, 0), _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null));
      t3 = A.DartStyle$(_null, B.AlignItems_1_center, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, B.Display_flex_3_flex, _null, _null, _null, _null, _null, _null, B.C_FlexWrap, _null, _null, _null, _null, _null, 12, _null, _null, _null, _null, _null, B.JustifyContent_P8D, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null);
      t4 = answer.$index(0, "author");
      t4 = t4 == null ? _null : J.toString$0$(t4);
      if (t4 == null)
        t4 = "Community";
      t4 = [A.Text_span("By " + t4, A.DartStyle$(_null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, new A.TokenRef(_s11_, _null), _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, 12, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null))];
      if (canDelete)
    ...
    _answerForm$0() {
      ...
      if (slug == null)
        slug = "";
      t1 = A.DartStyle$(_null, _null, _null, _null, _null, new A.TokenRef("color.panel", _null), _null, new A.Border(1, new A.TokenRef("color.line", _null), "solid"), _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, 0, _null, _null, _null, _null, _null, _null, new A.EdgeInsets(22, 22, 22, 22), _null, 16, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null);
      t2 = A.DartStyle$(_null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, B.Display_grid_5_grid, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, 14, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null);
      t3 = [];
      t4 = _this._answerMessage;
      if (t4 != null) {
        t5 = A.DartStyle$(_null, _null, _null, _null, _null, new A.Color("rgba(248, 113, 113, 0.08)"), _null, new A.Border(1, new A.Color("rgba(248, 113, 113, 0.35)"), "solid"), _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, new A.EdgeInsets(12, 12, 12, 12), _null, 10, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null);
        t4 = A.Text_p(t4, A.DartStyle$(_null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, new A.Color("#fca5a5"), _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, 13, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, new A.EdgeInsets(0, 0, 0, 0), _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null));
      ...
      t9.push(new A.FlintElement(_s8_, A.mergeComponentProps(t10, _null, A.inputComponentStyle(false, t5 != null && t5.length !== 0, B.ComponentSize_2, B.InputVariant_0).merge$1(B.DartStyle_6Lk).merge$1(t6), B.Map_empty1, B.Map_empty1), B.List_empty2));
  ...
  A.AuthPanel.prototype = {
    build$0() {
      var t6, t7, t8, _this = this, _null = null,
        ...
        _s8_ = "password",
        _s11_ = "color.muted",
        t1 = A.DartStyle$(_null, _null, _null, _null, _null, new A.TokenRef("color.panel", _null), _null, new A.Border(1, new A.TokenRef("color.line", _null), "solid"), _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, B.Display_grid_5_grid, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, 18, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, new A.EdgeInsets(24, 24, 24, 24), _null, 16, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null),
        t2 = A.Text_h2(_this.title, A.DartStyle$(_null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, new A.TokenRef("color.text", _null), _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, 22, 700, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, new A.EdgeInsets(0, 0, 0, 0), _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null)),
        t3 = A.Text_p(_this.body, A.DartStyle$(_null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, new A.TokenRef(_s11_, _null), _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, 14, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, 1.65, new A.EdgeInsets(0, 0, 0, 0), _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null)),
        t4 = A.DartStyle$(_null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, B.Display_flex_3_flex, _null, _null, _null, _null, _null, _null, B.C_FlexWrap, _null, _null, _null, _null, _null, 10, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null),
      ...
      if (t2 != null) {
        ...
        t2 = A.Text_p(t2, A.DartStyle$(_null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, new A.Color("#fca5a5"), _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, 13, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, new A.EdgeInsets(0, 0, 0, 0), _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null));
      ...
      t5 = A.DartStyle$(_null, B.AlignItems_1_center, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, B.Display_flex_3_flex, _null, _null, _null, _null, _null, _null, B.C_FlexWrap, _null, _null, _null, _null, _null, 12, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null);
      t6 = _this._loading;
      t7 = _this._showRegisterOverride;
      t8 = A.Icon$(t7 === true ? $.$get$Icons_plus() : $.$get$Icons_logIn(), _null, 15);
      t7 = _this._showRegisterOverride;
      t3.push(A.Row$([A.Button$(_null, [t8, A.Text_span(t7 === true ? _s14_ : "Sign in", _null)], _null, t6, new A.AuthPanel_build_closure1(_this), B.Map_empty1, B.ComponentSize_2, B.Tone_1, B.ButtonVariant_0), A.Link$(_this.backLabel, B.List_empty1, A.DartStyle$(_null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, new A.TokenRef(_s11_, _null), _null, _null, _null, B.Display_eAD, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, new A.EdgeInsets(8, 12, 8, 12), _null, 9, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null), _this.backHref, _null)], t5));
  ...
  A.NavBar.prototype = {
    ...
    _mobileActions$0() {
      ...
      t2.push(A.Button$("Menu", B.List_empty1, A.DartStyle$(_null, _null, _null, _null, _null, new A.TokenRef("color.panel", _null), _null, new A.Border(1, new A.Color("rgba(51, 65, 85, 0.95)"), _s5_), _null, _null, _null, _null, _null, _null, _null, _null, new A.TokenRef("color.muted", _null), _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, 12, 800, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, A.DartStyle$(_null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, B.Display_none_6_none, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null), _null, _null, _null, _null, _null, _null, _null, _null, 56, _null, _null, _null, _null, _null, _null, B.EdgeInsets_7_10_7_10, _null, new A.TokenRef(_s9_, _null), _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null), false, new A.NavBar__mobileActions_closure(_this), B.Map_empty1, B.ComponentSize_2, B.Tone_0, B.ButtonVariant_2));
      return A.Row$(t2, t1);
    },
    ...
    _mobileDrawer$0() {
      ...
      t4 = A.Row$([t5, A.Row$([_this._themeToggle$1$withLabel(true), A.Button$("Close", B.List_empty1, A.DartStyle$(_null, _null, _null, _null, _null, new A.TokenRef(_s11_, _null), _null, new A.Border(1, new A.Color("rgba(51, 65, 85, 0.95)"), "solid"), _null, _null, _null, _null, _null, _null, _null, _null, new A.TokenRef(_s11_0, _null), _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, 12, 800, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, 58, _null, _null, _null, _null, _null, _null, B.EdgeInsets_6_8_6_8, _null, new A.TokenRef(_s9_3, _null), _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null), false, new A.NavBar__mobileDrawer_closure0(_this), B.Map_empty1, B.ComponentSize_2, B.Tone_0, B.ButtonVariant_2)], t6)], t4);
  ...
  (function installTearOffs() {
    ...
    _static_1(A, "style___gradientStopValue$closure", "_gradientStopValue", 22);
  ...
  (function inheritance() {
    ...
    _inheritMany(A._Enum, [A.WebSocketConnectionState, A.FlintErrorKind, A.FlintResponseType, A.ToastPlacement, A.CookieSameSite, A.Breakpoint, A.FlintThemeMode, A.Display, A.FlexDirection, A.AlignItems, A.JustifyContent, A.Position, A.Tone, A.ComponentSize, A.ButtonVariant, A.InputVariant]);
    ...
    _inheritMany(A.StatefulComponent, [A.StateSignalListener, A.ApiSidebar, A.GuidesSidebar, A.QuestionDetailPage, A.AuthPanel, A.Footer, A.SiteLayout]);
  ...
  var init = {
    ...
    mangledNames: {},
    types: ["~()", "~(Object)", "Null(@)", "~(JSObject)", "~(@)", "bool(MapEntry<String,Object?>)", "String(MapEntry<String,Object?>)", "bool(String)", "~(~())", "Null()", "Null(JSObject)", "MapEntry<String,@>(@,@)", "bool(Map<String,@>)", "@(@)", "@(String)", "Null(Object,StackTrace)", "~(Object?,Object?)", "@()", "~(String,@)", "int()", "Future<~>()", "~(Timer)", "String(Object)", "Map<String,@>(Map<@,@>)", "List<Map<String,@>>(List<Map<String,@>>?)", "~(String,String?)", "~(String,Object?)", "Null(@,StackTrace)", "Map<String,String>(Map<String,String>,String)", "0&(String,int?)", "~(@,@)", "bool(String?)", "String(String?)", "String(MapEntry<String,DartStyle>)", "String(MapEntry<FlintThemeMode,DartStyle>)", "String(MapEntry<Breakpoint,DartStyle>)", "String(Object?{unitlessNumber:bool})", "Object?(Object?)", "String(KeyframeStep)", "String(StyleTransform)", "String(StyleTransition)", "Null(~())", "TextEditingController()", "0&()", "bool(String,List<String>)", "FlintElement(IconShape)", "bool(+(String,String))", "String()", "Object?(List<Map<String,@>>?)", "List<Function>()", "~(int,@)", "Button(FlintThemeMode)", "QuestionDetailPage(Map<String,@>)", "@(@,String)", "FlintNode(Object?)", "Future<~>(FlintPage,int)"],
...
;
    ...
    B.DartStyle_0x90 = new A.DartStyle(null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null);
    ...
    B.DartStyle_54s = new A.DartStyle(null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, B.Color_FZY, null, null, null, null, null, null, null, null, null, B.Color_RiS, null, B.Border_D1N, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null);
    B.C_Resize = new A.Resize();
    B.DartStyle_6Lk = new A.DartStyle(null, null, null, null, null, null, 96, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, B.C_Resize, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null);
    ...
    B.DartStyle_Dss = new A.DartStyle(null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, B.Color_FUE, null, null, null, null, null, null, null, null, null, B.Color_wdu0, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null);
    ...
    B.DartStyle_KXX = new A.DartStyle(B.EdgeInsets_8_10_8_10, null, null, null, null, null, 40, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, 14, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null);
    ...
    B.DartStyle_W1x = new A.DartStyle(B.EdgeInsets_6_8_6_8, null, null, null, null, null, 32, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, 12, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null);
    B.EdgeInsets_7_9_7_9 = new A.EdgeInsets(7, 9, 7, 9);
    B.DartStyle_YhP = new A.DartStyle(B.EdgeInsets_7_9_7_9, null, null, null, null, null, 36, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, 13, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null);
    ...
    B.DartStyle_Zk6 = new A.DartStyle(null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, B.Cursor_Yvp, null, null, null, null, null, null, null, null, null, null, 0.55, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null);
    B.EdgeInsets_10_12_10_12 = new A.EdgeInsets(10, 12, 10, 12);
    B.DartStyle_ZmF = new A.DartStyle(B.EdgeInsets_10_12_10_12, null, null, null, null, null, 46, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, 15, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null);
  ...
  (function lazyInitializers() {
    ...
    _lazyFinal($, "buttonBaseStyle", "$get$buttonBaseStyle", () => {
      var _null = null;
      return A.DartStyle$(_null, B.AlignItems_1_center, _null, _null, _null, _null, _null, A.Border$all(B.Color_transparent), _null, _null, _null, _null, _null, _null, _null, _null, _null, B.Cursor_pointer, _null, _null, B.Display_eAD, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, 600, 8, _null, _null, _null, _null, _null, B.JustifyContent_center_1_center, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, 8, _null, _null, _null, _null, _null, _null, _null, _null, B.C_TextDecorationStyle, _null, _null, _null, _null, A.StyleTransition_StyleTransition$colors(120), _null, _null, _null, _null, _null, _null, _null);
    });
    ...
    _lazyFinal($, "_textAreaStyle", "$get$_textAreaStyle", () => {
      var _null = null;
      return A.DartStyle$(_null, _null, _null, _null, _null, A.ThemeToken_color("panelStrong", _null), _null, A.Border$(A.ThemeToken_color("line", _null), "solid", 1), _null, _null, _null, _null, _null, _null, _null, _null, A.ThemeToken_color("text", _null), _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, 160, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null);
    });
    _lazyFinal($, "_inputStyle", "$get$_inputStyle", () => {
      var _null = null;
      return A.DartStyle$(_null, _null, _null, _null, _null, A.ThemeToken_color("panelStrong", _null), _null, A.Border$(A.ThemeToken_color("line", _null), "solid", 1), _null, _null, _null, _null, _null, _null, _null, _null, A.ThemeToken_color("text", _null), _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null);
    });
...
//# sourceMappingURL=question_detail.d9ae0a693862.dart.js.map
