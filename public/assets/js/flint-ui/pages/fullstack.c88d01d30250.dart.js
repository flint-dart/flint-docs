...
(function dartProgram() {
  ...
  A.FullstackPage.prototype = {
    build$0() {
      ...
      t3 = A.DartStyle$(_null, _null, _null, _null, _null, A.Background_Background$layers(A._setArrayType([A.Gradient_Gradient$linear(135, A._setArrayType([new A.GradientStop(B.Color_wdu, 0), new A.GradientStop(B.Color_fZl, 48), new A.GradientStop(new A.TokenRef(_s11_, _null), 100)], t3)), new A.TokenRef(_s11_, _null)], t3)), _null, new A.Border(1, new A.TokenRef(_s10_, _null), _s5_), _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, B.Display_grid_5_grid, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, 24, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, B.EdgeInsets_26_26_26_26, _null, 24, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null);
      t4 = A.DartStyle$(_null, B.AlignItems_1_center, _null, _null, _null, B.Color_wdu0, _null, new A.Border(1, B.Color_wdu1, _s5_), _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, B.Display_eAD, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, 10, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, B.EdgeInsets_6_12_6_12, _null, 999, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, new A.SizeValue("fit-content"), _null, _null, _null, _null);
      t4 = A.Row$([A.Icon$($.$get$Icons_layers(), B.Color_1Tn, 14), A.Text_span("Flint Dart Full-Stack Web Framework", B.DartStyle_kkD)], t4);
      t5 = A._element("h1", "Unified Full-Stack Dart Web Framework", _null, B.Map_empty1, B.Map_empty1, A.DartStyle$(_null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, new A.TokenRef("color.text", _null), _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, 36, 900, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, 1.1, _null, _null, _null, _null, B.DartStyle_kv6, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null));
      t6 = A.Text_p("Server APIs, declarative Web UI, Server-Side Rendering (SSR), Row-Level Security database gateways, and real-time WebSockets \u2014 all in pure Dart with zero context switching.", A.DartStyle$(_null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, new A.TokenRef("color.muted", _null), _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, 16, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, 1.6, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null));
      t3 = A.mergeComponentProps(B.Map_empty1, _null, t3, B.Map_empty1, B.Map_empty1);
      t6 = A.normalizeChildren(_null, [t4, t5, t6]);
      t5 = A.DartStyle$(_null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, B.Display_grid_5_grid, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, 16, _null, B.GridTemplateColumns_Boe, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, A.DartStyle$(_null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, new A.GridTemplateColumns("repeat(" + A._gridCssValue(3, true) + ", " + A._gridCssValue(B.C_GridTrack, false) + ")"), _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null), _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null);
      t4 = _this._featureCard$4$accent$desc$icon$title("#34d399", "High-performance HTTP server with middleware pipelines, controller routing, and session authentication.", $.$get$Icons_server(), "HTTP & Controller Core");
      t7 = _this._featureCard$4$accent$desc$icon$title("#38bdf8", "Pure Dart components, typed styling, reactive state signals, 2D canvas, and WebGL 3D scenes.", $.$get$Icons_palette(), "Declarative Web UI");
      t8 = _this._featureCard$4$accent$desc$icon$title("#a78bfa", "Built-in Row-Level Security (RLS), owner filters, query compilers, and protocol serialization.", $.$get$Icons_database(), "Secure DB API Gateway");
      t5 = A.mergeComponentProps(B.Map_IYyrU, _null, t5, B.Map_empty1, B.Map_empty1);
      t8 = A.normalizeChildren(_null, [t4, t7, t8]);
      ...
      t4 = t1.$index(0, "contentHtml");
      t4 = t4 == null ? _null : J.toString$0$(t4);
      if (t4 == null)
        t4 = "";
      t7 = A.mergeComponentProps(B.Map_empty1, _null, t7, B.Map_empty1, B.Map_empty1);
      t4 = A.normalizeChildren(_null, [new A.HtmlContent(t4, "fullstack-content", "api-md markdown-body", B.Map_rqkln)]);
      t2 = A.mergeComponentProps(B.Map_empty1, _null, t2, B.Map_empty1, B.Map_empty1);
      t4 = A.normalizeChildren(_null, [new A.Container(_s3_, t3, t6), new A.Container(_s3_, t5, t8), new A.Container(_s3_, t7, t4)]);
      return new A.SiteLayout(t1, new A.Container(_s3_, A.mergeComponentProps(B.Map_empty1, _null, B.DartStyle_4yO, B.Map_empty1, B.Map_empty1), A.normalizeChildren(_null, [new A.Container(_s3_, t2, t4)])));
    },
    _featureCard$4$accent$desc$icon$title(accent, desc, icon, title) {
      var t4, t5, _null = null,
        ...
        t2 = A.DartStyle$(_null, B.AlignItems_1_center, _null, _null, _null, new A.Color("rgba(52, 211, 153, 0.12)"), _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, B.Display_flex_3_flex, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, 36, _null, _null, B.JustifyContent_center_1_center, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, 8, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, 36, _null, _null, _null, _null),
        t3 = A.Icon$(icon, new A.Color(accent), 18);
      t2 = A.mergeComponentProps(B.Map_empty1, _null, t2, B.Map_empty1, B.Map_empty1);
      t3 = A.normalizeChildren(_null, [t3]);
      t4 = A._element("h3", title, _null, B.Map_empty1, B.Map_empty1, A.DartStyle$(_null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, new A.TokenRef("color.text", _null), _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, 16, 800, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null));
      t5 = A.Text_p(desc, A.DartStyle$(_null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, new A.TokenRef("color.muted", _null), _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, 13, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, 1.5, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null, _null));
  ...
  (function inheritance() {
    ...
    _inheritMany(A.StatefulComponent, [A.StateSignalListener, A.HtmlContent, A.ApiSidebar, A.GuidesSidebar, A.FullstackPage, A.Footer, A.SiteLayout]);
...
;
    ...
    B.Color_wdu = new A.Color("rgba(52, 211, 153, 0.22)");
    B.Color_wdu1 = new A.Color("rgba(52, 211, 153, 0.35)");
    ...
    B.DartStyle_Dss = new A.DartStyle(null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, B.Color_FUE, null, null, null, null, null, null, null, null, null, B.Color_wdu2, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null);
    ...
    B.DartStyle_kkD = new A.DartStyle(null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, 12, 800, null, 0.5, B.Color_1Tn, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null);
    ...
    B.Object_id_0 = {id: 0};
    B.Map_IYyrU = new A.ConstantStringMap(B.Object_id_0, ["features"], type$.ConstantStringMap_of_String_and_nullable_Object);
...
//# sourceMappingURL=fullstack.c88d01d30250.dart.js.map
