...
If the app has local docs generated by `flint agent`, read [Mail](/fullstack/guides/mail) before changing any email or OTP delivery code.
...
[Sessions And Cookies](/fullstack/guides/sessions-and-cookies) before implementing login or logout. JWT auth,
...
The `{{ ... }}` markers are Flint template variables. Read [Mail](/fullstack/guides/mail) for variables, nested values, filters, conditionals, loops, includes, and template safety rules.
...
or resend codes; use [Security And Utilities](/fullstack/guides/security-and-utilities) for rate-limit guidance.

## Implementation Checklist

When working on auth:

1. Read [Authentication](/fullstack/guides/authentication), then [Mail](/fullstack/guides/mail), [Middleware](/fullstack/guides/middleware), [Security And Utilities](/fullstack/guides/security-and-utilities), and [Validation](/fullstack/guides/validation).
